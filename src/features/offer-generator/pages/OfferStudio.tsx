...
const OfferStudioInner = () => {
  ...
  const { loggedUserClientLink, loggedUserRole: userRole } = useApp();
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-[220px] bg-zinc-900/95 backdrop-blur-xl border-zinc-800 rounded-xl p-1.5 shadow-2xl animate-in fade-in zoom-in-95 max-h-[350px] overflow-y-auto custom-scrollbar">
                ...
                {[...clients].filter(c => {
                  if (userRole === 'GUEST' && loggedUserClientLink) {
